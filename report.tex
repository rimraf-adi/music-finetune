...
We target the self-attention \textbf{Query} and \textbf{Value} matrices of the \textbf{last 2 layers} of the 12-layer encoder. With $r_{rank}=8$ and $\alpha=16$, the trainable parameter count drops to approximately 0.5\% of the full model size, significantly accelerating training speed and reducing GPU VRAM requirements.
